...
const AppointmentForm = ({userData }) => {
    ...
    useEffect(() => {
        const fetchAvailableTimeSlots = async () => {
            try {
                const response = await fetch(`/availableTimeSlots?doctor=${selectedDoctor}`);
    ...
    useEffect(() => {
        ...
        const fetchDoctors = async () => {
            try {
                const response = await fetch(`/doctors?department=${selectedDepartment}`);
                const data = await response.json();
                setDoctors(data);
            } catch (error) {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
          const response = await fetch('/submitAppointment', {
            method: 'POST',
            headers: {
