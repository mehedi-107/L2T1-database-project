...
const UpdateWard = () => {
    ...
    useEffect(() => {
        const fetchAvailableDoctors = async () => {
            try {
                const response = await fetch('/availableDoctorsWard');
        ...
        const fetchAvailableNurses = async () => {
            try {
                const response = await fetch('/availableNurses');
                const data = await response.json();
    ...
    const handleSearch = async () => {
        try {
            const response = await fetch(`/wardInfo/${wardId}`);
            const data = await response.json();
            setWardDetails(data);
        } catch (error) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`/updateWardDetails/${wardDetails.WARD_NO + wardDetails.FLOOR_NO * 100}`, {
                method: 'PUT',
                headers: {
            ...
            const updatedWardResponse = await fetch(`/wardInfo/${wardDetails.WARD_NO}`);
