...
router.put('/updateCabinDetails/:cabinId', async (req, res) => {
  ...
  try {
    ...
    const floorNo = Math.floor(cabinId / 100);
    const cabinNo = cabinId % 100;
...
router.get('/cabinDetails/:cabinId', async (req, res) => {
